...
<div class="dev3-2lvevpbewi200 section_wrapper">
    <div class="container-fluid">
        <nav class="dev3-25d3ticmqvls0  bg-orange ">
            <div class="dev3-243ztdnf8yww0 dev3-2gwcdwkqhmi00"><a href="#"><img src="assets/images/logo.png"
                        alt></a> <a href="#" class="dev3-di0jbv86i000"><i class="fa fa-times"></i></a> </div>
            <ul class="dev3-243ztdnf8yww0">
                <li class="dev3-3m8wtemb60w00 active-blue"> <a href="#">Saloons</a>
                    <div class="dev3-1gygrqpnsm5c0">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-2">
                                    <ul class="dev3-rkv9dgqv1b40">
                                        <li class="dev3-3b9hjbbf11e00">Women
                                        </li>
                                        <li><a href="#">sweaters</a></li>
                                        <li><a href="#">Trousers</a></li>
                                        <li><a href="#">Under Wears</a></li>
                                ...
                                <div class="col-12 col-lg-2">
                                    <ul class="dev3-rkv9dgqv1b40">
                                        <li class="dev3-3b9hjbbf11e00">>Foot Wear</li>
                                        <li><a href="#">Shoes</a></li>
                                ...
                                <div class="col-12 col-lg-3">
                                    <ul class="dev3-rkv9dgqv1b40">
                                        <li class="dev3-3b9hjbbf11e00">Fashion Accessories</li>
                                        <li><a href="#">Watches</a></li>
                                        <li><a href="#">Sunglasses</a></li>
                                        <li><a href="#">Perfumes</a></li>
                                        <li><a href="#">Face Creames</a></li>
                                        <li><a href="#">Hair Products</a></li>
                                    </ul>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <ul class="dev3-rkv9dgqv1b40">
                                        <li><img src="assets/images/ng-full-1.jpg" alt="Image" /></li>
                                    </ul>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <ul class="dev3-rkv9dgqv1b40">
                                        <li><img src="assets/images/ng-full-2.jpg" alt="Image" /></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <li class="dev3-3m8wtemb60w00"><a href="#">Tattoos Studio</a>
                ...
                <li class="dev3-3m8wtemb60w00"> <a href="#"><i class="bi bi-nut"></i>Event Planner</a>
                    <div class="dev3-1gygrqpnsm5c0 dev3-3ctdc4qetna00">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                ...
                                <div class="col-12 col-lg-6">
                                    <ul class="dev3-rkv9dgqv1b40">
                                        <li class="dev3-3b9hjbbf11e00">PRODUCT PAGES</li>
                                        <li><a href="#">Banner With Sidebar</a></li>
                                        <li><a href="#">Boxed Banner</a></li>
                                        <li><a href="#">Full Width Banner</a></li>
                                        <li><a href="#">Horizontal Filter</a></li>
                ...
                <li class="dev3-3m8wtemb60w00"> <a href="#">Tourism Management</a>
                    <div class="dev3-1gygrqpnsm5c0 dev3-3ctdc4qetna00">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-lg-6">
                ...
                <li class="dev3-3m8wtemb60w00"> <a href="#">Travels</a>
                    <div class="dev3-1gygrqpnsm5c0 dev3-3ctdc4qetna00">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-lg-6">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="exclusive_offer_heading">
                ...
                </div><p class="text-center"><a href="#" class="text-secondary">View More <i
...
<section class="bg-dark section_wrapper" style="background:url(https://freshcart.codescandy.com/assets/images/svg-graphics/pattern.svg)no-repeat; background-size: cover; background-position: center;border-radius: 20px;">
<div class="container-fluid">
   <!-- row -->
  <div class="row">
          ...
          <div class="text-white mt-8 mt-lg-0">
            ...
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Est perferendis quae quo
                ...
                quibusdam nisi pariatur eius ipsa in deleniti!</p><br/>
                    ...
                    <button type="button" class="btn btn-light m-auto" style="padding: 8px 25px;">More Products</button>
...
<img src="{{ asset('img/Saloon/banner_top1.png') }}" style=" position: absolute;top: -105%; right: 16px;font-size: 18px;z-index: 1;" class="topgirl">

<div class="container-fluid" style="background:url({{ asset('img/banner.png') }})no-repeat; background-size: cover; background-position: center;border-radius: 20px;position: relative;">
  <div class="row">
      ...
      <div class="row align-items-center">
        <div class="col-md-6">
          <div class="text-white mt-8 mt-lg-0">
            ...
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Est perferendis quae quoinventore quaerat nesciunt hic vel, harum rerum repellat</p><br/>
            <button type="button" class="btn btn-light m-auto" style="padding: 8px 25px;">More Deals</button>
          </div>
        </div>
