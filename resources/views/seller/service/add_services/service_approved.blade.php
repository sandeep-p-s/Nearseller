...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col">
                                <h4 class="page-title">Service Approval</h4>
                            </div>
            ...
            <form method="POST" action="{{ route('update.serviceapproval', $service->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group"><label>Approval Status</label>
                                            <select class="form-select form-control form-control-lg" name="productapproval"
                                                ...
                                                <option value="Y" @if ($service->is_approved == 'Y') selected @endif>Approved</option>
                                                <option value="N" @if ($service->is_approved == 'N') selected @endif>Not Approved</option>
                                                <option value="R" @if ($service->is_approved == 'R') selected @endif>Rejected</option>
                                            </select>
