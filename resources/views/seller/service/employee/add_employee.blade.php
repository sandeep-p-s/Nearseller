                        ...
                        <div class="card-body">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="horizontalCheckbox"
                                    ...
                                    @if (old('is_same_permanent_address')) checked @endif>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select form-control form-control-lg" name="present_country"
                                    ...
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->id }}"
                                            @if (old('country') == $country->id) selected @endif>{{ $country->country_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" aria-label="Default select example" id="present_district"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="present_pincode"
                                    placeholder="Enter pincode" name="present_pincode" maxlength="6">
