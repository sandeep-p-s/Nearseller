...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col">
                                <h4 class="page-title">Approved Shop Offer</h4>
                            </div>
                            <div class="col">
            ...
            <form action="{{ route('approvedstatus.shopoffer', $shopoffer->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="offer"
                                                ...
                                                value="{{ $shopoffer->offer_to_display }}" readonly>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" class="form-control" id="from_time"
                                                        ...
                                                        value="{{ $shopoffer->from_date_time }}" readonly>
                                        ...
                                        <div class="form-group"><label>Approval Status</label>
                                            <select class="form-control" id="shopofferapproved" name="shopofferapproved">
                                                ...
                                                <option value="N" {{ $shopoffer->approval_status  == 'N' ? 'selected' : '' }}>
                                                    Not Approved
                                                </option>
