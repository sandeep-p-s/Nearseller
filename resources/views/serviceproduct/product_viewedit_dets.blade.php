<form id="ProductRegFormEdit" enctype="multipart/form-data" method="POST">
    <input type="hidden" id="serprod_id" name="serprod_id" class="form-control" placeholder="Service ID"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group" {{ $shopshowhide }}><label>Service Provider Name<span
                        ...
                        <select class="selectshopss form-control form-control-lg" id="shop_names" name="shop_names"
                            required tabindex="1">
                                        ...
                                        @foreach ($productAttibutes as $attribte)
                                            <div data-repeater-item="">
                                                <div class="form-group row d-flex align-items-end">
                                                    ...
                                                    <div class="col">
                                                        <input type="text" id="offerprices1" name="offerprices1" maxlength="10"
                                                            placeholder="Offer Price" class="form-control"  oninput="numberOnlyAllowedDot(this)"
                                                            value="{{ $attribte->offer_price }}">
                                                    </div>
                                                    <div class="col">
                                                        <input type="text" id="mrprices1" name="mrprices1" maxlength="10"
                                                            placeholder="MRP" class="form-control"  oninput="numberOnlyAllowedDot(this)"
                                                            value="{{ $attribte->mrp_price }}">
                                                    </div>
                                                    <div class="col">
                                                        <input type="text" id="attr_calshops1" name="attr_calshops1" maxlength="10"
                                                            placeholder="Call Shop" class="form-control"  oninput="numberOnlyAllowed(this)"
