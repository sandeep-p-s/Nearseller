    ...
    <div class="page-content section_wrapper">
        <div class="container-fluid">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-center" id="ViewEditModalLabel">View / Edit - Customer Details</h5>
            ...
            <div class="modal fade" id="ShopApprovedModal" tabindex="-1" aria-labelledby="ShopApprovedModalLabel"
                ...
                <div class="modal-dialog custom-modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-center" id="ShopApprovedModalModalLabel">Customer Approved</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                title="Close">x</button>
                        </div>
                        <div class="modal-body">
        ...
        <script>
            function shwdets() {
                ...
                $.ajax({
                    url: '{{ route('cust.allcustomersview') }}',
                    type: 'GET',
                    data: {
                        emal_mob: emal_mob,
                        uname: uname,
            ...
            function check() {
                ...
                if (document.getElementById('checkbox1').checked == true) {
                    for (i = 1; i <= document.getElementById('totalshopcnt').value; i++) {
                        document.getElementById('customerid' + i).checked = true;
                    }
                } else {
                    for (i = 1; i <= document.getElementById('totalshopcnt').value; i++) {
                        document.getElementById('customerid' + i).checked = false;
                    }
                }
            ...
            function customer_approvedall() {
                var customerid = '';
                var totalshopcnt = document.getElementById('totalshopcnt').value;
                for (var i = 1; i <= totalshopcnt; i++) {
                    var checkbox = document.getElementById('customerid' + i);
                    if (checkbox && checkbox.checked) {
                        customerid = customerid + '#' + checkbox.value;
                    }
                }
                if (customerid === '') {
                ...
                var csrfToken = $('meta[name="csrf-token"]').attr('content');
                $.ajax({
                    url: '{{ route('CustomersApprovedAll') }}',
                    type: 'POST',
                    data: {
