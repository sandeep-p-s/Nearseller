                        ...
                        <div class="form-outline mb-3"><label >Social Media</label>
                                ...
                                @foreach($qrsocialmediaval as $n => $media)
                                    ...
                                    <div class="row mb-5" id="added_fieldemh{{ $n + 1 }}">
                                        <div class="col-md-3 fv-row fv-plugins-icon-container">
                                            <select class="form-select form-control form-control-lg" id="mediatype" name="mediatype[{{ $n }}]" tabindex="21">
                                                <option value="0" {{ $mediatype == '0' ? 'selected' : '' }}>Choose...</option>
                                                <option value="1" {{ $mediatype == '1' ? 'selected' : '' }}>Facebook</option>
                                                <option value="2" {{ $mediatype == '2' ? 'selected' : '' }}>Instagram</option>
                                                <option value="3" {{ $mediatype == '3' ? 'selected' : '' }}>LinkedIn</option>
                                                <option value="4" {{ $mediatype == '4' ? 'selected' : '' }}>Website URL</option>
                                                <option value="5" {{ $mediatype == '5' ? 'selected' : '' }}>YouTube Video URL</option>
                                            </select>
                                        </div>

                                        <div class="col-md-9 fv-row fv-plugins-icon-container">
                                            <div class="input-group">
                                                <input type="text" id="mediaurl" name="mediaurl[{{ $n }}]" class="form-control form-control-lg" placeholder="https://" value="{{ $mediaurl }}" tabindex="22" maxlength="60" />
                                                <div  align="right"><button id="removeRowsh {{$n+1}}" type="button" name="add_fieldh" class="btn btn-danger" onClick="removeRowdh('{{$n+1}}');" >-</div>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="col-md-12 row" align="right">
                                    <div class="form-group">
                                        <button id="addMoreRowssh" type="button" name="add_fieldssh" class="btn icon btn-outline-primary btn-sm mt-3">+ Add More Social Media</button>
                                    </div>
                                </div>

                                <div id="addedRowssh"></div>
                                <input type="hidden" name="cntmedia" id="cntmedia" value="{{ $cntmedia }}" class="form-control" />
