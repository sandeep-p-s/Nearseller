                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('update.businesstype', $businesstype->id) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb15" id="exampleFormControlInput1" name="business_name"
                                            placeholder="Enter business type" value="{{ $businesstype->business_name }}">
