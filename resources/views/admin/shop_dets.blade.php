                        ...
                        <div class="btn-group mb-2 mb-md-0">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item approve_btn" href="#"
                                    onclick="shopapprovedet({{ $sellerDetail->id }})">Approved</a>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Shop Name</label>
                                    <input type="text" id="s_name" name="s_name"
                                        class="form-control form-control-lg" maxlength="50" placeholder="Shop Name"
                                        required tabindex="1" />
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Mobile
                                        Number</label>
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Referral
                                        ID</label>
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Business
                                        Type</label>
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Shop / Service
                                        Type</label>
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Shop Executive
                                        Name</label>
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Social
                                        Media</label>
                                    <div class="row mb-5">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Building/House
                                        Name & Number</label>
                                ...
                                <div class="form-outline mb-3"><label class="lblname"
                                        for="lblname">Village/Town/Municipality</label>
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Google map link
                                        location</label>
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Shop
                                        Photo's</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">License
                                        Number</label>
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">GST
                                        Number</label>
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">PAN
                                        Number</label>
                                ...
                                <div class="form-outline mb-3"><label class="esdate" for="esdate"> Establishment
                                        Date</label>
                                ...
                                <div class="form-outline mb-3"><label class="regis_date" for="regis_date">
                                ...
                                <div class="form-outline mb-3"><label class="lblname" for="lblname">Manufactoring
                                        Details</label>
