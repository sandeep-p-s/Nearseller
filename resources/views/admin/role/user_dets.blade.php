                    ...
                    <td>
                        <div class="btn-group mb-2 mb-md-0">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item view_btn1" href="#" onclick="uservieweditdet({{ $userDets->id }})">View/Edit</a>
                                @if($userDets->role_id!='1')
                                <a class="dropdown-item delete_btn" href="#" onclick="userdeletedet({{ $userDets->id }})">Delete</a>
                                @endif
                            </div>
                        </div>
                    </td>
                ...
                <div class="row">
                    <div class="col-md-12">
                         ...
                         <div class="form-outline mb-3"><label >User Role</label>
                            <select class="form-select form-control form-control-lg" name="roleid"  aria-label="Default select example" id="roleid" required  tabindex="2" >
                        ...
                        <div class="form-outline mb-3"><label >Name</label>
                            <input type="text" id="s_name" name="s_name" class="form-control form-control-lg" maxlength="50"  placeholder="Name" required  tabindex="2" />
        ...
        $("#UserRegForm").validate({
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#userreg-message').text('User creation successful. Please verify email and login!').fadeIn();
