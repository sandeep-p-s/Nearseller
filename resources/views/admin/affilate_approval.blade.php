        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="afflitename" name="afflitename" class="form-control  form-control-lg"
                        placeholder="Affiliate Name" onchange="shwdets();" />
                </div>

                <div class="col-md-4">
                    <input type="text" id="referalid" name="referalid" class="form-control  form-control-lg"
                        placeholder="Refferal ID" onchange="shwdets();" />
                ...
                <div class="modal-dialog custom-modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                title="Close">x</button>
                            <div class="modal fade" id="AffiliateApprovedModal" tabindex="-1"
                                aria-labelledby="AffiliateApprovedModalLabel" aria-hidden="true">
                                <div class="modal-dialog custom-modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title text-center" id="AffiliateApprovedModalLabel">Affilates
                                                Approved</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close" title="Close">x</button>
                                        </div>
                                        <div class="modal-body">
                            ...
                            <div class="modal fade" id="deleteConfirmationModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteConfirmationModalLabel">Confirm Deletion
                                            </h5>
                                            <button type="button" class="btn-close" class="btn-close"
