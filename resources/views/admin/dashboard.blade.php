                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <a href="{{ route('cust.custaproval', 1) }}" class="badge p-2 badge badge-info"
                                            style="color: #fff;
                                background-color: #f19207;">View
                                            All</a>
                                    </div>
                                    <div class="col-auto align-self-center">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <a href="#" class="badge p-2 badge badge-info"
                                            style="color: #fff;
                                background-color: #f19207;">View
                                            All</a>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <a href="{{ route('admin.shopapprovals', 1) }}" class="badge p-2 badge badge-info"
                                            style="color: #fff;
                                  background-color: #f19207;">View
                                            All</a>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <a href="{{ route('admin.shopapprovalsinactive', 1) }}"
                                            class="badge p-2 badge badge-info"
                                            style="color: #fff;
                                  background-color: #f10707;">View
                                            All</a>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <a href="{{ route('admin.shopapprovals', 2) }}" class="badge p-2 badge badge-info"
                                            style="color: #fff;
                                  background-color: #f19207;">View
                                            All</a>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <a href="{{ route('admin.shopapprovalsinactive', 2) }}"
                                            class="badge p-2 badge badge-info"
                                            style="color: #fff;
                                  background-color: #f10707;">View
                                            All</a>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        ...
                                        <a href="#" class="badge p-2 badge badge-info"
                                            style="color: #fff;
                                background-color: hsl(251, 94%, 49%);">View
                                            All</a>
                                    </div>
                                    <div class="col-auto align-self-center">
                                        <div class="report-main-icon bg-light-alt">
